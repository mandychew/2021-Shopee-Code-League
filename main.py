...
# create binary labels and adding short form words to dictionary_POI for all addresses with POI
...
# filter out words that contain only digits or have 0 characters from dictionary_POI
...
# Tokenizing sentences_to_tokenize; padding list_of_addresses_withPOI
trunc_type = 'post'
padding = 'post'
oov_tok="<OOV>"
...
data_sequences = tokenizer_POI.texts_to_sequences(list_of_addresses_withPOI)
padded_POI = pad_sequences(data_sequences, maxlen=max_length_address, truncating=trunc_type, padding=padding)
print(padded_POI[0])
...
# create binary labels and adding short form words to dictionary_ST for all addresses with ST
labels_binary_ST, dictionary_ST = binary_labels_and_dict(list_of_addresses_withST, list_of_ST, dictionary_ST)


# filter out words that contain only digits or have 0 characters from dictionary_ST
...
# Tokenizing sentences_to_tokenize; padding list_of_addresses_withST
trunc_type = 'post'
padding = 'post'
oov_tok="<OOV>"
...
data_sequences = tokenizer_ST.texts_to_sequences(list_of_addresses_withST)
padded_ST = pad_sequences(data_sequences, maxlen=max_length_address, truncating=trunc_type, padding=padding)
